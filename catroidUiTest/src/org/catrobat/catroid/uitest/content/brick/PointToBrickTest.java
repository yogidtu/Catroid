...
public class PointToBrickTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {
	...
	private void createProject() {
		...
		Reflection.setPrivateField(project.getXmlHeader(), "virtualScreenHeight", 1920);
		Reflection.setPrivateField(project.getXmlHeader(), "virtualScreenWidth", 1200);
	...
	private void createNewObjectWithinBrick(String objectName, int stringToClickOnAtTheEnd) {
		...
		assertTrue("Dialog not shown",
				solo.waitForText(solo.getString(R.string.dialog_new_object_switch_message), 0, 5000));
