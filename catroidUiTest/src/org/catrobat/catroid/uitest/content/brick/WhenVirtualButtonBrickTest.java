...
public class WhenVirtualButtonBrickTest extends ActivityInstrumentationTestCase2<ScriptActivity> {

	private Solo solo;
	private Project project;

	public WhenVirtualButtonBrickTest() {
	...
	public void testWhenVirtualButtonBrick() {
		...
		assertNotNull("TextView does not exist",
				solo.getText(solo.getString(R.string.brick_when_virtual_button_pressed)));
	...
	private void createProject() {
		...
		Script script = new WhenVirtualButtonScript(sprite);
