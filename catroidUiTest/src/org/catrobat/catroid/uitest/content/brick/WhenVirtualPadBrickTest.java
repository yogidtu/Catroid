...
public class WhenVirtualPadBrickTest extends ActivityInstrumentationTestCase2<ScriptActivity> {

	private Solo solo;
	private Project project;

	public WhenVirtualPadBrickTest() {
	...
	public void testWhenVirtualPadBrick() {
		...
		assertNotNull("TextView does not exist", solo.getText(solo.getString(R.string.brick_when_virtual_pad_pressed)));
	...
	private void createProject() {
		...
		Script script = new WhenVirtualPadScript(sprite);
