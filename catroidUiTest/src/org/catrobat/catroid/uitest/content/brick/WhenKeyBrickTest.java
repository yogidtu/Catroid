...
public class WhenKeyBrickTest extends ActivityInstrumentationTestCase2<ScriptActivity> {
	...
	public void testWhenKeyBrick() {
		...
		UiTestUtils.addNewBrick(solo, R.string.brick_when_key_pressed);
		...
		//UiTestUtils.addNewBrick(solo, UiTestUtils.getBrickCategory(solo, R.string.brick_when_key_pressed), R.string.brick_when_key_pressed, 1);
		//UiTestUtils.addNewBrick(solo, R.string.brick_when_key_pressed);
		//change
		...
		UiTestUtils.addNewBrick(solo, UiTestUtils.getBrickCategory(solo, R.string.brick_when_key_pressed),
				R.string.brick_when_key_pressed, 1);
		//UiTestUtils.addNewBrick(solo, R.string.brick_when_key_pressed);
