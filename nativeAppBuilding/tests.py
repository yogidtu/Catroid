...
class TesthandleProject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.project_filename = os.path.join('test_resources', 'projectcode.xml')
        self.new_project_filename = os.path.join('test_resources',
                'modified_projectcode.xml')
    ...
    def test_rename_resources_and_project_name(self):
        ...
        shutil.copyfile(self.project_filename, temp_project_filename)
