...
public class WhenKeyActionTest extends AndroidTestCase {

	public void testWhenKeyBrick() throws InterruptedException {
		int testPosition = 100;

		Sprite sprite = new Sprite("new sprite");
		WhenKeyScript whenKeyScript = new WhenKeyScript(sprite);
		whenKeyScript.setKeyCode(Key.KEY_PADUP.getKeyCode());
		...
		sprite.createWhenKeyScriptActionSequence(whenKeyScript.getKeyCode());
