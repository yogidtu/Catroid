...
public class SetFrictionBrick implements PhysicObjectBrick, OnClickListener {
	...
	@Override
	public void execute() {
		physicObject.setFriction(friction / 100.0f);
	}
	...
	public View getPrototypeView(Context context) {
		...
		View view = inflater.inflate(R.layout.brick_set_friction, null);
		return view;
	}

	@Override
	public Brick clone() {
		return new SetFrictionBrick(sprite, friction);
	}
