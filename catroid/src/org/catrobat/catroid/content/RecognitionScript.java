...
public class RecognitionScript extends Script implements BroadcastMessage {

	private static final long serialVersionUID = 1L;
	private String recognizeKeyword;

	public RecognitionScript(Sprite sprite, String broadcastMessage) {
		super(sprite);
	...
	public ScriptBrick getScriptBrick() {
		if (brick == null) {
			brick = new WhenSpeechReceiverBrick(object, this);
		}
		return brick;
	}
	...
	public void setBroadcastMessage(String recognizeKeyword) {
		this.recognizeKeyword = recognizeKeyword;
	}

	@Override
	public Script copyScriptForSprite(Sprite copySprite) {
		RecognitionScript cloneScript = new RecognitionScript(copySprite, recognizeKeyword);
