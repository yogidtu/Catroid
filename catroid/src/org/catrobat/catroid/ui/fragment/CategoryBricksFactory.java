...
public class CategoryBricksFactory {
	...
	private List<Brick> setupControlCategoryList(Sprite sprite, Context context) {
		...
		controlBrickList.add(new WhenVirtualPadBrick(sprite, null, WhenVirtualPadBrick.Direction.UP));
		controlBrickList.add(new WhenVirtualButtonBrick(sprite, null, Action.TOUCH));
