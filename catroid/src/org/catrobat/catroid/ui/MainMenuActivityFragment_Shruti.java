...
public class MainMenuActivityFragment_Shruti extends SherlockFragment implements OnCheckTokenCompleteListener,
	...
	/*
	 * public void onDetach() { super.onDetach(); if
	 * (!Utils.externalStorageAvailable()) { return; }
	...
	public void handleProgramsButton(View v) {
		...
		mCallbacklist.onArticleSelectedList(1);
	}
	...
	OnHeadlineSelectedListenerList mCallbacklist;
	OnWebSelectedListener mWeb;

	public interface OnHeadlineSelectedListenerList {
		public void onArticleSelectedList(int i);
	}

	public interface OnWebSelectedListener {
		public void onWebSelected(int i);
	}
